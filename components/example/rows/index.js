...
export const InfoButton = props => (
  <BorderlessButton {...props} style={styles.infoButton} onPress={() => alert(`${props.name} info button clicked`)}>
    ...
    return (
      <View style={styles.container}>
        <ScrollView waitFor={['dragbox', 'image_pinch', 'image_rotation', 'image_tilt']} style={styles.scrollView}>
          ...
          <View style={styles.buttonDelimiter} />
          <RectButton rippleColor="red" style={styles.rectButton} onPress={() => alert('Third row clicked')}>
          ...
          <View style={styles.buttonDelimiter} />
          <Swipeable>
            <RectButton enabled={false} style={styles.rectButton} onPress={() => alert('Fourth row clicked')}>
              <Text style={styles.buttonText}>This row is "disabled" but you can swipe it</Text>
              <InfoButton name="fourth" />
            </RectButton>
          </Swipeable>
          <LongPressGestureHandler
            onHandlerStateChange={({ nativeEvent }) => nativeEvent.state === State.ACTIVE && alert('Long')}>
            <RectButton rippleColor="red" style={styles.rectButton} onPress={() => alert('Fifth row clicked')}>
              <Text style={styles.buttonText}>Clickable row with long press handler</Text>
            </RectButton>
          </LongPressGestureHandler>
          <LoremIpsum />
        </ScrollView>
