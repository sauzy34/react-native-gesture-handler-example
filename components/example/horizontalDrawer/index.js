...
const Page = ({ fromLeft, type, parallaxOn, flipSide, nextType, openDrawer }) => (
  <View style={styles.page}>
    ...
    <RectButton style={styles.rectButton} onPress={flipSide}>
      <Text style={styles.rectButtonText}>Drawer to the {fromLeft ? 'left' : 'right'}! -> Flip</Text>
    </RectButton>
    ...
    <TextInput style={styles.pageInput} placeholder="Just an input field to test kb dismiss mode" />
  </View>
)
