...
class Tracking extends Component {
  ...
  render() {
    return (
      <View style={{ position: 'absolute', left: 0, right: 0, top: 0, bottom: 0 }} onLayout={this._onLayout}>
        <Animated.Image
          style={[
            styles.box,
            { marginLeft: 10, marginTop: 10 },
            {
              transform: [{ translateX: this._follow2x }, { translateY: this._follow2y }]
            }
          ]}
          source={{
        ...
        <Animated.Image
          style={[
            ...
            {
              transform: [{ translateX: this._follow1x }, { translateY: this._follow1y }]
            }
          ]}
          source={{
        ...
        <PanGestureHandler onGestureEvent={this._onGestureEvent} onHandlerStateChange={this._onHandlerStateChange}>
          <Animated.Image
            style={[
              styles.box,
              {
